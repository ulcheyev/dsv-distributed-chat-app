  ...
  public static final class Builder extends
    ...
    private void buildPartial0(generated.RoomEntry result) {
      ...
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.roomBackup_ = roomBackupBuilder_ == null
            ? roomBackup_
            : roomBackupBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              input.readMessage(
                  getRoomBackupFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    public Builder mergeRoomBackup(generated.Remote value) {
      if (roomBackupBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          roomBackup_ != null &&
          roomBackup_ != generated.Remote.getDefaultInstance()) {
          getRoomBackupBuilder().mergeFrom(value);
        } else {
          roomBackup_ = value;
        }
      } else {
